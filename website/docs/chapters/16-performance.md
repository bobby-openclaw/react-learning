...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    WHERE PERFORMANCE OPTIMIZATIONS APPLY                     │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│   ┌────────────┐       ┌────────────┐       ┌────────────┐                 │
│   │  RE-RENDER │──────▶│    DIFF    │──────▶│ DOM COMMIT │                 │
│   │            │       │            │       │            │                 │
...
│   ├─────────────────────────────────────────────────────────────────────┤  │
│   │                                                                      │  │
│   │   SKIP THE RE-RENDER          MAKE THE RE-RENDER FASTER              │  │
│   │   ──────────────────          ─────────────────────────              │  │
│   │   • React.memo()              • useMemo() for expensive calcs        │  │
│   │   • Move state down           • Lazy state initialization           │  │
│   │   • Lift content up           • Derive during render                │  │
│   │   • React Compiler 🆕         • Code splitting (React.lazy)          │  │
│   │                                                                      │  │
│   └─────────────────────────────────────────────────────────────────────┘  │
│                                                                              │
